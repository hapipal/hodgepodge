...
module.exports = (plugins, looseTally) => {
    ...
    const processPlugin = (plugin) => {
        ...
        list.add(hodgepodging ? internals.makePlugin(pluginFn) : plugin, {
            after: deps,
...
internals.makePlugin = (pluginFn) => {

    const plugin = pluginFn.bind();
    plugin.attributes = Object.assign({}, pluginFn.attributes);
    plugin.attributes.dependencies = plugin.attributes.dependencies.hodgepodge;
